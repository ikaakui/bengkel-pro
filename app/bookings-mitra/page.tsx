...
export default function BookingsPage() {
    ...
    const [activeTab, setActiveTab] = useState<BookingTab>('referral');
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div>
                        <h2 className="text-3xl font-bold text-slate-900">
                            {isAdmin ? 'Booking Mitra' : 'Referral Bookings'}
                        </h2>
                        <p className="text-slate-500 mt-1">
                            {isAdmin
                                ? `Kelola booking titipan mitra cabang ${branchName || ''}.`
                    ...
                    <div className="flex gap-3">
                        {isAdmin && (
                            <Button
                                ...
                                className="h-12 px-6 shadow-md shadow-blue-200"
                            >
                    ...
                    <Card className="border-blue-200 bg-blue-50/50">
                        <CardHeader>
                            <h3 className="text-xl font-bold flex items-center gap-2">
                                ...
                                Input Kode Booking Mitra
                            </h3>
                            <p className="text-sm text-slate-500 mt-1">Masukkan kode booking dari customer yang datang dengan referral mitra.</p>
                        </CardHeader>
                        <CardContent>
                            <div className="flex gap-3">
                            ...
                            {foundBooking && foundBooking.status === 'pending' && (
                                ...
                                >
                                    ...
                                    <div className="grid grid-cols-2 gap-4 text-sm">
                                        ...
                                        <div>
                                            <p className="text-xs text-slate-400 font-bold uppercase">Mitra</p>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                                ...
                                <div className="flex items-end lg:col-span-3 justify-end mt-2">
                                    <Button className="w-full sm:w-auto px-8 h-11" variant="success"
                                        onClick={handleSaveBookingMitra}
                                        disabled={isSaving}
                                    >
                                        {isSaving ? <Loader2 size={18} className="animate-spin mr-2" /> : null}
                                        {isSaving ? "Menyimpan..." : "Simpan & Generate Kode"}
                                    </Button>
                                </div>
                            </div>
                        </CardContent>
                            ...
                            <div className="p-4 sm:p-6 overflow-y-auto space-y-4 sm:space-y-5 flex-1 min-h-0">
                                ...
                                <div className="flex flex-wrap items-center gap-2">
                                    ...
                                    {selectedBooking.booking_type === 'direct' || !selectedBooking.mitra_id ? (
                                        <Badge variant="neutral" className="text-xs bg-slate-200 text-slate-600">🏷️ DIRECT</Badge>
                                    ) : (
                                        <Badge variant="info" className="text-xs">🤝 VIA MITRA</Badge>
                                    )}
                                </div>
