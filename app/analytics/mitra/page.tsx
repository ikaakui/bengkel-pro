            ...
            <div className="space-y-10">
                <div>
                    <h2 className="text-3xl font-black text-slate-900 tracking-tight flex items-center gap-3">
                        <Users2 className="text-emerald-600" /> Analisis Mitra
                    </h2>
                    <p className="text-slate-500 mt-1 font-medium">Monitoring kontribusi mitra terhadap pertumbuhan bisnis.</p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    <Card className="p-6 border-none shadow-xl bg-white flex flex-col justify-between">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] text-slate-400 font-black uppercase tracking-widest mt-1">Total Mitra Terdaftar</p>
                        </div>
                    </Card>
                    ...
                    <Card className="xl:col-span-2 border-none shadow-2xl bg-white p-0 overflow-hidden">
                        <div className="p-8 border-b border-slate-50 flex items-center justify-between bg-slate-50/30">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <h3 className="text-xl font-black text-slate-900 tracking-tight">Mitra MVP Leaderboard</h3>
                                    <p className="text-xs text-slate-500 font-medium">Mitra dengan performa terbaik berdasarkan revenue.</p>
                                </div>
                            </div>
                        </div>
