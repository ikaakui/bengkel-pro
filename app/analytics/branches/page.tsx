...
export default function BranchAnalyticsPage() {
    ...
    const fetchBranchData = async () => {
        ...
        try {
            ...
            const mockCompare = [
                { name: 'Depok', revenue: currentMonthRev * 0.6, target: (Object.values(targetMap)[0]?.target || 250000000) },
                { name: 'BSD', revenue: currentMonthRev * 0.4, target: (Object.values(targetMap)[1]?.target || 250000000) }
            ];
            setBranchComparison(mockCompare);
