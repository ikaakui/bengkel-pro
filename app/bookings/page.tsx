                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div>
                        <h2 className="text-3xl font-bold text-slate-900">
                            {isAdmin ? 'Booking Direct' : 'Referral Bookings'}
                        </h2>
                        <p className="text-slate-500 mt-1">
                            {isAdmin
                                ? `Kelola booking langsung (Walk-in) cabang ${branchName || ''}.`
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                                ...
                                <div className="flex items-end lg:col-span-3 justify-end mt-2">
                                    ...
                                    >
                                        ...
                                        {isSaving ? "Menyimpan..." : isAdmin ? "Simpan Direct" : "Simpan & Generate Kode"}
                                    </Button>
                                </div>
                            </div>
                        </CardContent>
                ...
                {/* {isAdmin && (
                    <div className="flex gap-2 p-1.5 bg-slate-100/80 rounded-2xl w-fit">
                        {([
                            ...
                            { key: 'direct' as BookingTab, label: 'Direct', icon: User },
                            { key: 'referral' as BookingTab, label: 'Via Mitra', icon: Users },
                        ]).map(tab => (
                            <button
                                key={tab.key}
