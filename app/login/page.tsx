        ...
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 p-4">
            ...
            >
                ...
                <div className="text-center mb-8 flex flex-col items-center">
                    ...
                    <h1 className="text-3xl font-bold text-slate-900 tracking-tight">BENGKEL PRO</h1>
                </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="flex justify-end">
                                <button
                                    type="button"
                                    onClick={() => {
                                        const message = encodeURIComponent(`Halo Admin, saya lupa password akun BENGKEL PRO saya. Mohon bantuannya untuk reset password. Email saya: ${email || "[Masukkan Email]"}`);
