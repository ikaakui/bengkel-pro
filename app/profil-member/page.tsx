                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div className="lg:col-span-1 space-y-6">
                            <motion.div 
                                ...
                                className={cn(
                                    "relative h-64 rounded-[2.5rem] p-8 text-white shadow-2xl bg-gradient-to-br overflow-hidden perspective-1000",
                                    currentTier.color
                                )}
                            >
                                ...
                                <div className="relative z-10 h-full flex flex-col justify-between">
                                    ...
                                    <div className="flex justify-between items-end">
                                        ...
                                        <div className="text-right">
                                            <p className="text-[10px] font-bold uppercase tracking-widest opacity-60 mb-1">Sejak</p>
                                            <p className="text-xs font-black">{new Date(profile?.created_at || "").getFullYear()}</p>
                                        </div>
                                    </div>
                                </div>
                            </motion.div>
                            ...
                            <Card className="border-slate-100 text-center space-y-4">
                                ...
                                <div>
                                    <p className="text-3xl font-black text-slate-900">{profile?.total_points?.toLocaleString()}</p>
                                    <p className="text-xs font-bold text-slate-400 uppercase tracking-widest mt-1">Poin Loyalitas</p>
                                </div>
                                <Button 
                                    variant="outline" 
                                    className="w-full rounded-2xl border-amber-200 text-amber-600 hover:bg-amber-50"
                        ...
                        <div className="lg:col-span-2 space-y-8">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                    <div className="space-y-4">
                                        ...
                                        {isEditing ? (
                                            ...
                                            <p className="text-lg font-bold text-slate-900 px-2 flex items-center gap-3">
                                    ...
                                    <div className="space-y-4">
                                        <label className="text-xs font-black text-slate-400 uppercase tracking-widest">WhatsApp / Telepon</label>
                                        {isEditing ? (
                                            <input 
                                                type="text" 
                                                className="w-full px-5 py-4 bg-slate-50 border-2 border-slate-100 rounded-2xl focus:outline-none focus:border-primary focus:bg-white transition-all font-bold"
                                ...
                                {isEditing && (
                                    <div className="mt-10 flex justify-end">
                                        <Button 
                                            ...
                                            className="h-14 px-10 rounded-2xl shadow-xl shadow-primary/20 gap-2 font-black"
                                        >
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    {/* Mocking vehicle list for now as per UI request */}
                                    <Card className="border-slate-100 p-6 flex flex-col justify-between group hover:border-primary transition-colors">
                                        <div className="flex justify-between items-start">
                                        ...
                                        <div className="mt-6">
                                            <p className="text-lg font-black text-slate-900">Toyota Avanza</p>
                                            <p className="text-sm font-bold text-slate-400 font-mono tracking-widest mt-1">B 1234 ABC</p>
                                        </div>
                                        <div className="mt-6 flex items-center justify-between text-xs font-bold text-slate-400">
                                            <span className="flex items-center gap-1">
                                                <Calendar size={12} />
                                                Terakhir Servis: 12 Jan 2024
                                            </span>
                                    ...
                                    <button className="border-2 border-dashed border-slate-200 rounded-3xl p-10 flex flex-col items-center justify-center gap-3 text-slate-400 hover:border-primary hover:text-primary transition-all group">
                                        <div className="w-12 h-12 rounded-full border-2 border-dashed border-slate-200 flex items-center justify-center group-hover:border-primary">
                                            <Plus size={24} />
                                        </div>
                                        <span className="font-bold">Daftarkan Mobil Baru</span>
                                    </button>
                                </div>
                            </div>
                        </div>
