...
export default function OwnerDashboard() {
    ...
    const [quickStats, setQuickStats] = useState({ mitra: 0, pendingWD: 0 });
    ...
    const fetchOverviewData = async () => {
        ...
        try {
            ...
            setQuickStats({ mitra: mCount || 0, pendingWD: pWD || 0 });
        ...
        <div className="space-y-10 pb-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <Card className="p-6 border-none shadow-xl bg-white flex flex-col justify-between">
                    ...
                    <div>
                        <p className="text-2xl font-black text-slate-900 tracking-tighter italic">{quickStats.mitra}</p>
                        <p className="text-[10px] text-slate-400 font-black uppercase tracking-widest mt-1">Total Jaringan Mitra</p>
                    </div>
                </Card>
