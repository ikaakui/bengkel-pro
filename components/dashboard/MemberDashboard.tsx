    ...
    return (
        <div className="space-y-10 pb-10">
            ...
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                <div>
                    <h2 className="text-3xl font-bold text-slate-900 ">Halo, {profile?.full_name?.split(' ')[0] || 'Member'}! 👋</h2>
                    <p className="text-slate-500 mt-1">Pantau performa dan poin Anda hari ini.</p>
                </div>
                <div className="flex gap-3">
                    <Button
                        variant="primary"
                        onClick={() => router.push('/bookings-member')}
